<!-- https://uxcandy.co/demo/label-free/preview/demo_1/index.html -->
<!-- header-fixed -->
...
<div>
	...
	<div class="item-purchase-banner" style="display: none;">
		...
		<a href="http://www.uxcandy.co/product/label-pro-admin-template/" target="_blank" class="banner-button btn btn-primary btn-icon">                 <i class="mdi mdi-cart mr-2"></i>Buy Now              </a>              <span class="toggler-close"><i class="mdi mdi-close"></i></span>          
	</div>
	<!-- partial:partials/_header.html -->
	<nav class="t-header">
		<div class="t-header-brand-wrapper"><a href="index.html"><img class="logo" src="https://uxcandy.co/demo/label-free/preview/assets/images/logo.svg" alt=""> <img class="logo-mini" src="https://uxcandy.co/demo/label-free/preview/assets/images/logo_mini.svg" alt=""></a></div>
		<div class="t-header-content-wrapper">
			<div class="t-header-content">
				<button class="t-header-toggler t-header-mobile-toggler d-block d-lg-none"><i class="mdi mdi-menu"></i></button>
				<form action="#" class="t-header-search-box">
					<div class="input-group"><input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Search" autocomplete="off"> <button class="btn btn-primary" type="submit"><i class="mdi mdi-arrow-right-thick"></i></button></div>
				</form>
							...
							<div class="dropdown-body">
								<div class="dropdown-list">
									<div class="image-wrapper">
										<img class="profile-img" src="https://uxcandy.co/demo/label-free/preview/assets/images/profile/male/image_1.png" alt="profile image">
								...
								<div class="dropdown-list">
									<div class="image-wrapper">
										<img class="profile-img" src="https://uxcandy.co/demo/label-free/preview/assets/images/profile/female/image_2.png" alt="profile image">
										<div class="status-indicator rounded-indicator bg-success"></div>
									</div>
								...
								<div class="dropdown-list">
									<div class="image-wrapper">
										<img class="profile-img" src="https://uxcandy.co/demo/label-free/preview/assets/images/profile/male/image_3.png" alt="profile image">
	...
	<div class="page-body">
		...
		<div class="sidebar">
			<div class="user-profile">
				<div class="display-avatar animated-avatar"><img class="profile-img img-lg rounded-circle" src="https://uxcandy.co/demo/label-free/preview/assets/images/profile/male/image_1.png" alt="profile image"></div>
			...
			<ul class="navigation-menu">
                ...
                <template v-for="m in $store.state.nav.admin">
                    <template v-if="m.children.length">
                        <li>
                            <a href="javascript:;">
                                <span class="link-title">{{ m.title }}</span>
                                <i :class="m.icon" class="link-icon"></i>
                            </a>
                            <ul class="navigation-submenu collapse show">
                                <li v-for="mm in m.children">
				...
				<li><a href="javascript:;"><span class="link-title">Documentação</span> <i class="mdi mdi-asterisk link-icon"></i></a></li>
			</ul>
		</div>
		<!-- partial -->
		<div class="page-content-wrapper" style="margin:0;">
...
<style>
@import url('https://uxcandy.co/demo/label-free/preview/assets/css/shared/style.css');
@import url('https://uxcandy.co/demo/label-free/preview/assets/css/demo_1/style.css');
</style>